...
style_list = "21B. Specialty IPA: Belgian IPA"
style_list = "21A. American IPA"
orientacoes = get_system_prompt()

gpt_message = [
        {
            "role": "system", 
            "content": f"{orientacoes}"""
        },
        {
            "role": "user", 
            "content": f"O estilo a ser resumido são: {style_list}"
        }
    ]
